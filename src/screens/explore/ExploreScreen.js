...
const ALL_PRODUCTS = [
    { id: 'p1', name: 'Air Max Prestige', price: 4299, originalPrice: 7000, discount: 39, rating: 4.5, reviews: 128, category: 'Fashion', badge: 'HOT', badgeColor: '#F5C842', emoji: '👟' },
    { id: 'p2', name: 'Gold Watch Pro', price: 8999, originalPrice: 14000, discount: 36, rating: 4.8, reviews: 312, category: 'Jewels', badge: 'EXCLUSIVE', badgeColor: '#7B5EEA', emoji: '⌚' },
    { id: 'p3', name: 'Pixel 9 Ultra', price: 72000, originalPrice: 85000, discount: 15, rating: 4.7, reviews: 541, category: 'Tech', badge: 'NEW', badgeColor: '#60A5FA', emoji: '📱' },
    { id: 'p4', name: 'Sony WH-1000XM5', price: 18999, originalPrice: 29990, discount: 37, rating: 4.8, reviews: 5441, category: 'Tech', badge: 'TOP RATED', badgeColor: '#4ADE80', emoji: '🎧' },
    { id: 'p5', name: 'Diamond Pendant', price: 12500, originalPrice: 18000, discount: 31, rating: 4.6, reviews: 89, category: 'Jewels', badge: 'TRENDING', badgeColor: '#F5C842', emoji: '💎' },
    { id: 'p6', name: 'Silk Kurta Set', price: 3200, originalPrice: 5000, discount: 36, rating: 4.4, reviews: 203, category: 'Fashion', badge: 'HOT', badgeColor: '#F472B6', emoji: '👗' },
    { id: 'p7', name: 'Smart Speaker', price: 5499, originalPrice: 8000, discount: 31, rating: 4.3, reviews: 167, category: 'Tech', badge: 'NEW', badgeColor: '#60A5FA', emoji: '🔊' },
    { id: 'p8', name: 'Leather Wallet', price: 1299, originalPrice: 2000, discount: 35, rating: 4.5, reviews: 432, category: 'Fashion', badge: 'SALE', badgeColor: '#FB923C', emoji: '👛' },
    { id: 'p9', name: 'Scented Candle Set', price: 899, originalPrice: 1500, discount: 40, rating: 4.2, reviews: 76, category: 'Home', badge: 'SALE', badgeColor: '#FB923C', emoji: '🕯️' },
    { id: 'p10', name: 'Yoga Mat Pro', price: 2199, originalPrice: 3500, discount: 37, rating: 4.6, reviews: 234, category: 'Sports', badge: 'HOT', badgeColor: '#4ADE80', emoji: '🧘' },
    { id: 'p11', name: 'Lipstick Collection', price: 799, originalPrice: 1200, discount: 33, rating: 4.3, reviews: 512, category: 'Beauty', badge: 'NEW', badgeColor: '#F472B6', emoji: '💄' },
    { id: 'p12', name: 'Running Shoes X3', price: 5999, originalPrice: 9000, discount: 33, rating: 4.7, reviews: 389, category: 'Sports', badge: 'TRENDING', badgeColor: '#4ADE80', emoji: '👠' },
    { id: 'p13', name: 'Indoor Plant Pot', price: 699, originalPrice: 1100, discount: 36, rating: 4.1, reviews: 94, category: 'Home', badge: 'SALE', badgeColor: '#FB923C', emoji: '🪴' },
    { id: 'p14', name: 'Emerald Ring', price: 22000, originalPrice: 35000, discount: 37, rating: 4.9, reviews: 67, category: 'Jewels', badge: 'EXCLUSIVE', badgeColor: '#7B5EEA', emoji: '💍' },
    { id: 'p15', name: 'MacBook Air M3', price: 114900, originalPrice: 129900, discount: 12, rating: 4.9, reviews: 823, category: 'Tech', badge: 'NEW', badgeColor: '#60A5FA', emoji: '💻' },
    { id: 'p16', name: 'Face Serum Kit', price: 1499, originalPrice: 2500, discount: 40, rating: 4.4, reviews: 318, category: 'Beauty', badge: 'HOT', badgeColor: '#F472B6', emoji: '🧴' },
];

const CATEGORIES = [
    { id: 'all', name: 'All', icon: 'grid-outline', color: '#7B5EEA' },
    { id: 'Fashion', name: 'Fashion', icon: 'shirt-outline', color: '#F472B6' },
    { id: 'Tech', name: 'Tech', icon: 'phone-portrait-outline', color: '#60A5FA' },
    { id: 'Jewels', name: 'Jewels', icon: 'diamond-outline', color: '#F5C842' },
    { id: 'Home', name: 'Home', icon: 'home-outline', color: '#4ADE80' },
    { id: 'Beauty', name: 'Beauty', icon: 'rose-outline', color: '#F472B6' },
    { id: 'Sports', name: 'Sports', icon: 'fitness-outline', color: '#FB923C' },
];
